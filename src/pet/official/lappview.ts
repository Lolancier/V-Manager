...
export class LAppView {
  ...
  _back: { release: () => void; render: (programId: WebGLProgram) => void; isHit?: (x: number, y: number) => boolean } | null;
  _gear: { release: () => void; render: (programId: WebGLProgram) => void; isHit: (x: number, y: number) => boolean } | null;
